...
import net.mcreator.meow.procedure.ProcedureScript;
...
public class GuiGui extends ElementsMeow.ModElement {
	public static int GUIID = 2;
	public static HashMap guistate = new HashMap();
	public GuiGui(ElementsMeow instance) {
		super(instance, 5);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				Meow.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("meow232:textures/gui.png");
		@Override
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 73, this.guiTop + 50, 60, 20, "button"));
		}

		@Override
		protected void actionPerformed(GuiButton button) {
			Meow.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
		...
		if (buttonID == 0) {
			{
				...
				ProcedureScript.executeProcedure($_dependencies);
			}
		}
	}
